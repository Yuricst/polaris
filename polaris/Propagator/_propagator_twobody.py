...
def propagate_twobody(
    ...
    if events == None and ivp_method == "LSODA" and force_solve_ivp == False:
        # use odeint
        propout = propagate_twobody_odeint(
            mu,
            state0,
            tf,
            steps=steps,
        ...
        # use solve_ivp
        propout = propagate_twobody_solve_ivp(
            mu,
            state0,
            tf,
            steps=steps,
...
# ---------------------------------------------------------------------------------------- #
def propagate_twobody_solve_ivp(
    mu,
    state0,
    tf,
    steps=2000,
